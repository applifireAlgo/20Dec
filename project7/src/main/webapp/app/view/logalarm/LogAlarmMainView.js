 ...
 * 
 */
Ext.define('Project7.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Project7.view.logalarm.LogAlarmMainViewController',
			'Project7.view.logalarm.tree.LogAlarmTreePanel',
			'Project7.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',

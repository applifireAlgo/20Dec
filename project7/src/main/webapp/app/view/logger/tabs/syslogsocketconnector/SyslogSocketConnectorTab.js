 ...
 * 
 */
Ext.define('Project7.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Project7.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],

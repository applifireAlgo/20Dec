Ext.define('Project7.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Project7.view.searchengine.search.NorthPanel', 'Project7.view.searchengine.search.SearchResult','Project7.view.searchengine.search.SearchEngineMainPanelController'],

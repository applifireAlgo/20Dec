Ext
		.define(
				'Project7.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Project7.view.searchengine.search.SearchEngineMainPanelController','Project7.view.searchengine.search.PanelHeaderField' ,'Project7.view.searchengine.search.ReportGridView','Project7.view.searchengine.search.ReportChartView','Project7.view.searchengine.search.documentView','Project7.view.searchengine.search.DouMeanView','Project7.view.googlemaps.map.MapPanel'],

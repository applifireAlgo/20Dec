 ...
 */
Ext.define('Project7.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Project7.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Project7.view.fw.component.DateTimePicker(o);
    },

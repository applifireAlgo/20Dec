Ext.define('Project7.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Project7.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Project7.view.console.ConsoleWindow');

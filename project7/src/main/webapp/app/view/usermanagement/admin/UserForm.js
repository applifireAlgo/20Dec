Ext.define('Project7.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Project7.view.usermanagement.admin.AddUserDetailsViewModel', 'Project7.model.AddUserDataModel' ],

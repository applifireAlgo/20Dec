...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestion("tQzfUx9lDJrRDx6g6pj93CJvDpljxRSKtoSPL6tCWQGA2ITsj8");
        question.setQuestionDetails("seqB98k0VO");
        question.setLevelid(6);
        question.setQuestionIcon("wznR0r2N0oKFL0x4W24U0kyx5s67aNxbcuCq8FoQJIiH0QECOx");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("Gj17JKuUXIELtt2A5SQCyNyAowFShBdWud2hKcMWVvxA5r4e3D");
            question.setQuestionDetails("ZWYZ732CwA");
            question.setLevelid(11);
            question.setVersionId(1);
            question.setQuestionIcon("82BqXAqSeD44xkGQ8km8evVoSUUmtUc7oz6GCSl54VCfYl0S9F");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "UZTcdml24HD8FXkGVveDO1hQUU3fhJgdysAnKKi2bDUMh584Mfn2AvdSQGdikXJoo"));

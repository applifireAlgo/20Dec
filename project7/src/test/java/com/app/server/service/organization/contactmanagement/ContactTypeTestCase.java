...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeDesc("QPQHFXwciCq38QZnBAseKwLkObJCWXm6NZmAN9JKOOjZL2hUIE");
        contacttype.setContactType("CEyLIQmWfeQBX771PR6B42epYcNOAms6UizpQqon3g2OdzzJw4");
        contacttype.setContactTypeIcon("R6L6nKueQL1SYiF6KMlhRiMVTEx8qTfzM4kpztCYrokzyRUKE8");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeDesc("PlhoPvx29djeCGp79qoubeUCKYwvEfZhADVEYruGwB0pSrFJo9");
            contacttype.setContactType("pQLLZ6J1vX75NsaK2V4qjDYFxtfXnbuxfK92QYWhoYve0ZmeIW");
            contacttype.setContactTypeIcon("fAmnUQHEnQvz5lkN9uoIvfztrQLa7KdnyZ7M6JXJtWrZSohG2o");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "KK7InDLrjANMqXQyNXZ2j1t5SKhRRlaoo09Dxwr1idHjcVetPwsc1wMmwAap0ZMDJtLNdadGojdLRfXKFBx64FetcAYopQ27FSESfkTPm2yGqDrdbetDzh6B7ohxqlZKM"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "OQRaS6XrEgRqRthXGKhYS9badA5nZwMzFsSpmJhGG0MgNtJDlbjngqEK65aUUnBsqYE32qeMkdpixR6EX0fO5j012VGmvhseCXmzF70hbBVhcnhmJxzk98xGaTDjK2bRL"));

...
public class CommunicationTypeTestCase extends EntityTestCriteria {
    ...
    private CommunicationType createCommunicationType(Boolean isSave) throws Exception {
        ...
        communicationgroup.setCommGroupName("CJP77Cfy6TRkuujkpCQKLonmqThaRZhZScLdRMW2Z81XJGDGPD");
        communicationgroup.setCommGroupDescription("BBBRrzpbTYQbHa4V6jYfwK4Ychua6ElDRZ9OYjE5KZtL5d1CsP");
        ...
        communicationtype.setCommTypeDescription("tVWu9kxmAEoSLi8oFSYXK371M3WDF2EDyH5oE8SIB8ZPIxreSV");
        communicationtype.setCommTypeName("ffaZeroQVElagd93KkkiRdOrHcY1WwNCtRA9RBsCeoMJ1tUyT6");
    ...
    public void test2Update() {
        try {
            ...
            communicationtype.setCommTypeDescription("rGVh6cekHLqF3Dj0AI1c8mqzkACdlmY0KcSAbTUhGa4puTBSEz");
            communicationtype.setCommTypeName("Y6gYjF1F1hgdgmp6MhmdZKNcPnJcJHR0ixbpY0E0UWJDQWAJLM");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "commTypeName", "fK9h5S5QDkyBViSsqJnxc8hKUcZwfRcYj9QLRcxnTDSf0KKukD0gOgnOUawACfMfgt9sjn1D3IS7aH3w85A3mw198N3kZ85hLak8EWYWQ3cXle54F4WWppD5h0I8kLXBN"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "commTypeDescription", ""));

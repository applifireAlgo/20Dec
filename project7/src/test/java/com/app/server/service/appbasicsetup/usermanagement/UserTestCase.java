...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccessdomain.setDomainIcon("9Mcxq8PCcyZdrbMnf2xqUvSV2RdxGOysg4crC0up7kqPRGm11B");
        useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
        useraccessdomain.setDomainDescription("EqU2bTmI6kCHCt4D3SUu685v2mN46HHGogNkjmH6FMUts4krG9");
        useraccessdomain.setDomainHelp("A21K9RQU3Dh7ouVxK6Eah1Jh6VVo3rPMVOTbq11ajo9lSjyF5D");
        useraccessdomain.setDomainName("KO32gjidnUdE71nkX9mkBOUzrONuGIKp3KD6vTqzmZ0iqW2ZHe");
        ...
        useraccesslevel.setLevelName("OvndLsb6u8gXeY6el1UFZ1jPeClgbmoN7NsttDz7qjoytwqn6e");
        useraccesslevel.setLevelDescription("YdfGF4itRDUSfumJ6BQyl2JR0jV5yAs0h0EwhhTmvK6vd9b2Ei");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelIcon("7KBwsElAxqg9UhkxIruuin4rbl7P1iAnj2siyUG8r07U1bvnOc");
        useraccesslevel.setLevelHelp("iT5WYqKVz8vLOl6JZcWIwvUmWFYewr0MAV3VVJpIlLytH3x5mr");
        ...
        user.setIsLocked(1);
        user.setPasswordExpiryDate(new java.sql.Timestamp(1464879976386l));
        user.setIsDeleted(1);
        user.setSessionTimeout(256);
        user.setMultiFactorAuthEnabled(1);
        user.setGenTempOneTimePassword(1);
        user.setChangePasswordNextLogin(1);
        user.setPasswordAlgo("l0wNmwBYuDcMTc1F4W2hezAifOThv4gKxRsiOGfweTbNLIFV0C");
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1464879976386l));
        user.setAllowMultipleLogin(1);
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessCode(7050);
        java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
        PassRecovery passrecovery = new PassRecovery();
        passrecovery.setAnswer("FNIhVYpIhaqd0gZBQGdobU42pYVIbtNpQpNLsbABPZXNbb5krW");
        Question question = new Question();
        question.setQuestion("IxoXKN6Ah5d8mJjTTZwSD7At8UgCvHLsSvaUC8cdYsxSvJcDBL");
        question.setQuestionDetails("2OWel9BogV");
        question.setLevelid(7);
        question.setQuestionIcon("daBKy6RTlHAjsvoEuAsMVxdlEJSBGN6Zao9Ru9GJCGW8uJvsUA");
        Question QuestionTest = new Question();
        if (isSave) {
            QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
        }
        passrecovery.setAnswer("Om1zPx93crqwGpWVg7ugCOnkaR7n0B2NGOj4Pot8NhRoPygPOX");
        passrecovery.setQuestionId((java.lang.String) QuestionTest._getPrimarykey());
        passrecovery.setUser(user);
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464879976621l));
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464879976634l));
        userdata.setUser(user);
        userdata.setOneTimePasswordExpiry(5);
        userdata.setLast5Passwords("EKjlpHulpw9leC3YVEmofZVqKqPULPwaDM1ESIle8uYVGXeLtl");
        userdata.setPassword("1zWVUVUNpdsM9YWn8eppei30p0YrdUuM2ruW95bTmvgri0RwJp");
        userdata.setOneTimePassword("q0V3jYiM6B0EU6N2kEw4ZnMNAdgvapyl");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 74698));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "E7BdBODCkPex5zZdkEgq7jHUxn2HicCmS6tY4CKBVOtsOpnk3xHobVkAtxHy61AbI"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 6553));
